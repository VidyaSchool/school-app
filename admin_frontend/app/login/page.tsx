              ...
              <div className="space-y-6">
                <div className="flex flex-col gap-1.5 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Access school administration and management console
                  </p>
                </div>
                  ...
                  <FieldGroup>
                    ...
                    <Field>
                      <div className="flex items-center">
                        ...
                        <a href={`${MAIN_FRONTEND_URL}/forgot-password`} className="ml-auto text-xs underline-offset-4 hover:underline text-muted-foreground hover:text-foreground">
                          Forgot password?
                        </a>
                      </div>
      ...
      <div className="relative hidden bg-muted lg:block">
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
          <Image
            ...
            alt="VidyaSchool Administration"
            width={340}
            height={340}
            className="object-contain animate-fade-in mb-6"
          />
          <h2 className="text-xl font-bold tracking-tight">VidyaSchool Administration</h2>
          <p className="text-sm text-muted-foreground max-w-sm mt-2">
            Centralized console for academics, teacher management, student records, fee control, and school governance.
          </p>
        </div>
      </div>
