...
const MAIN_FRONTEND_URL = process.env.NEXT_PUBLIC_MAIN_URL || (typeof window !== 'undefined' && window.location.hostname !== 'localhost' ? 'https://vidyaschool.com' : 'http://localhost:3000')
